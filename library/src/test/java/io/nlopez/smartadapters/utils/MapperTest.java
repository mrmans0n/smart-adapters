...
public class MapperTest {
    ...
    public void test_add() {
        Mapper mapper = new Mapper(new HashMap<Class, List<Class<? extends BindableFrameLayout>>>(),
                new HashMap<Integer, Class<? extends BindableFrameLayout>>());
    ...
    public void test_adding_duplicates_chains_objects() {
        ...
        List<Class<? extends BindableFrameLayout>> classes = mapper.get(MockModel.class);
        assertThat(classes)
